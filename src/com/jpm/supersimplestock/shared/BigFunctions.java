...
/**
 * NOTE:
 * This is not my class, but i used for calculation, becuase in pure JAVA
 * for BigDecimal class exist onnly pow function for integer value.
 * In math we remember that
 *          z = x^y --> z = exp ( ln(x) * y )
 *  so if we use this library we can use BigDecimal for calculation of GBCE.
 */
